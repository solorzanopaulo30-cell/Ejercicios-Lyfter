...
#O(n²) — hay un for anidado dentro de otro for, ambos recorriendo


#¿Cuanto dura si hay 1 millón de claves?
# Con n = 1,000,000, se ejecutarían n² = 1,000,000,000,000 (un billón)
# iteraciones. Aunque cada iteración es rápida, un billón de operaciones
# tardaría varios minutos u horas en ejecutarse, haciendo la función